describe "post" do
    ...
    context "quando full_name é nulo" do
        ...
        let(:result) { ApiUser.save(build(:null_full_name).to_hash) }
    ...
    context "quando e-mail é nulo" do
        ...
        let(:result) { ApiUser.save(build(:null_email).to_hash) }
    ...
    context "quando password é nulo" do
        ...
        let(:result) { ApiUser.save(build(:null_password).to_hash) }
